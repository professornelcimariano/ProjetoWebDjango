...
from core.views import index, contato, produtos, produto_single, produtos_categoria, blogs, blog_single
#Rota na url 
...
urlpatterns = [
    ...
    path('produtos/<str:cat>/', produtos_categoria, name='produtos_categoria'),
